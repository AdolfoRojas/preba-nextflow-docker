...
process Cellranger { // 6.0.2
    ...
    script:
    """
    $params.cellranger_path count --id=Mapped_$sample_id --fastqs=$reads --sample=$sample_id --transcriptome=$params.ref_data --localcores $task.cpus
    """
}
...
workflow prueba {    
    ...
    Seurat_Object(SoupX_scDblFinder.out.clean_reads.collect())       
    }
}
//nextflow /media/storage2/Adolfo2/LatinCells/LatinCells/singleCell.nf '--dataDir=/media/storage2/Adolfo2/LatinCells/workflow_test/RawData_test/*' -resume